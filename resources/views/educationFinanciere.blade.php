...
@include('layouts.side_bar')
    ...
    <div class="main-side col-10 container  gx-5" style="overflow-y: scroll; overflow-x: hidden;"  >
            <div class="row  d-flex align-items-center w-100 " style="flex-wrap: nowrap;height: 10%;">
                <h1 class="h1  text gx-5 mt-3 col-9 ms-1 fs-1" >Education financiere</h1>
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            <tr class="d-flex flex-wrap ">
                                ...
                                <td>
                                    <div class="progress-bar ">
                                        <div class="progresscontainers d-flex w-100 h-100 bg-danger">
                                ...
                                <td class="  ">
                                    ...
                                    <div style="max-width: 150px;" class="input-group me-2 d-flex flex-nowrap">
                                        <input type="text" value="15000"  class="form-control" aria-label="Amount (to the nearest dollar)">
                            ...
                            <tr class="d-flex flex-wrap ">
                                ...
                                <td>
                                    <div class="progress-bar ">
                                        <div class="progresscontainers d-flex w-100 h-100 bg-success">
                                          <div class="progress-block"></div>
                                        <div class="progress-block"></div>
                                        <div class="progress-block"></div>
                                        <div class="progress-block"></div>
