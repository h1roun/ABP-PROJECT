           ...
           <div class="ajout-popup col-9 col-lg-4 d-none  border background" style="max-width: 400px; z-index: 20;  border-radius: 20px;">
            <div class="p-4">
                <form method="POST" action="{{ route('promotions.store') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="" class="d-none form-label col-7" ><h6> Nom de la promotion:</h6></label>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <div style=" width: 120px;" class="input-group">
                                <input type="text" name="discount_percentage" class="form-control" aria-label="Amount (to the nearest dollar)">
                                <span style="color: gray;" class="input-group-text">%</span>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary" style="color: white;"  >Confirmer</button>
                </form>
