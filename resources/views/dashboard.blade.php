    ...
    <div class="main row" >
        ...
        <div class="main-side col-10 container  gx-5"  style="overflow: scroll;" >
            ...
            <div class="row  gy-10 " style="height: 90%;">
                ...
                <div class=" w-100  container border background" style=" min-height: 90%;border-radius: 20px;">
                    <div class=" row d-flex  gy-2 mt-4" >
                        <div class="col d-flex flex-column align-items-center">
                            ...
                            <p class="fs-2 mb-0 ">{{ $studentCount }} Etudiants</p>
                        ...
                        <div class="col d-flex flex-column align-items-center">
                            ...
                            <p class="fs-2 mb-0">{{ $coursesCount }} Cours </p>
                        ...
                        <div class="col d-flex flex-column align-items-center">
                            ...
                            <p class="fs-2 mb-0">{{$FormationCount}} Formations</p>
                            <p class=" ">en cours de déroulement</p>
                        </div>
                        <div class="col d-flex flex-column align-items-center">
                            ...
                            <p class="fs-2 mb-0">0 promotions</p>
                            <p class=" ">en cours de déroulement</p>
                        </div>
                    </div>
                    ...
                    <div class="row gx-1 gy-1 "  >
                        ...
                        <div class="col-4   text-light rounded cours-section" >
                         <a href="{{ route('enrollments.index', ['courseId' => $today_course->id]) }}" class="text-light" >
